            ...
            <div class="row">
                @foreach ($com_ac as $blog)
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30" onclick="window.location.href='{{  route('frontend.blog_detail', ['id' => $blog->id, 'status' => $blog->status])}}';" style="cursor: pointer;">
                            <div class="blog-img-cap" >
                                ...
                                <div class="blog-cap">
                                    ...
                                    <h3>
                                        <a href="{{ route('frontend.blog_detail', ['id' => $blog->id, 'status' => $blog->status]) }}">{{ $blog->blog_title }}</a>
                                    </h3>
                                    <p>
