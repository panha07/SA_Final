    ...
    <div class="container bg-white mb-4 p-4 rounded shadow-sm">
        ...
        <form id ="jobForm" action="{{ route('store_job') }}" method="POST">
            ...
            <div class="mb-3 mt-5">
                ...
                <textarea class="form-control" id="jobDescription" rows="15" name="description">{{ old('description') }}</textarea>
            </div>
            <div class="mb-3 row bg-red p-2 rounded">
            ...
            <div class="mb-3 mt-5">
                ...
                <textarea class="form-control" id="jobRequirementsDescription" rows="15" name="requirements">{{ old('requirements') }}</textarea>
            </div>
